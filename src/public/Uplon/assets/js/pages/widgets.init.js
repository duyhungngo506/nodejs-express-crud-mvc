!(function (e) {
    'use strict';
    var a = function () {};
    (a.prototype.createAreaChart = function (e, a, t, r, i, n, o, s) {
        Morris.Area({
            element: e,
            pointSize: 0,
            lineWidth: 0,
        ...
        (a.prototype.createStackedChart = function (e, a, t, r, i, n) {
            Morris.Bar({
                element: e,
                data: a,
                xkey: t,
...
var chart = new Chartist.Pie(
    '#animating-donut',
    { series: [10, 20, 50, 20], labels: [1, 2, 3, 4] },
...
chart.on('draw', function (e) {
    if ('slice' === e.type) {
        ...
        0 !== e.index &&
            (t['stroke-dashoffset'].begin = 'anim' + (e.index - 1) + '.end'),
