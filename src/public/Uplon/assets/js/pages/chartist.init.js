...
new Chartist.Line('#scatter-diagram', data, options, responsiveOptions),
    new Chartist.Line(
        '#line-chart-tooltips',
        {
            labels: ['1', '2', '3', '4', '5', '6'],
            series: [
                { name: 'Fibonacci sequence', data: [1, 2, 3, 5, 8, 13] },
                {
                    name: 'Golden section',
...
new Chartist.Bar('#overlapping-bars', data, options, responsiveOptions),
    ...
    new Chartist.Bar(
        ...
        { distributeSeries: !0, plugins: [Chartist.plugins.tooltip()] },
    ),
    new Chartist.Bar(
...
(chart = new Chartist.Line(
    ...
    [
        [
            ...
            {
                series: {
                    'series-1': { lineSmooth: Chartist.Interpolation.none() },
                    'series-2': {
    ...
    (chart = new Chartist.Line(
        ...
        },
        {
            low: 0,
            showLine: !1,
            axisX: { showLabel: !1, offset: 0 },
            axisY: { showLabel: !1, offset: 0 },
            plugins: [Chartist.plugins.tooltip()],
        },
    )),
    (seq = 0);
chart.on('created', function () {
    ...
    chart.on('draw', function (e) {
        'point' === e.type &&
            e.element.animate({
                opacity: { begin: 80 * seq++, dur: 500, from: 0, to: 1 },
                x1: {
                    begin: 80 * seq++,
                    dur: 500,
                    from: e.x - 100,
