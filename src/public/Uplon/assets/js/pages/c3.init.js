        ...
        c3.generate({
            ...
            c3.generate({
                ...
                data: {
                    ...
                    types: { data1: 'bar' },
                    colors: { data1: '#3db9dc', data2: '#ff5d48' },
                },
            ...
            c3.generate({
                ...
                data: {
                    ...
                    colors: { data1: '#ff7aa3', data2: '#9261c6' },
                },
            }),
            c3.generate({
                bindto: '#donut-chart',
                ...
                donut: { title: 'Dogs love:', width: 15, label: { show: !1 } },
                color: { pattern: ['#ebeff2', '#ff5d48', '#3db9dc'] },
            }),
            c3.generate({
                bindto: '#pie-chart',
                data: {
            ...
            c3.generate({
                ...
                data: {
                    ...
                    colors: { data1: '#039cfd', data2: '#1bb99a' },
                },
            }),
            c3.generate({
                bindto: '#scatter-plot',
                ...
                axis: {
                    x: { label: 'Sepal.Width', tick: { fit: !1 } },
                    y: { label: 'Petal.Width' },
                },
            });
    }),
