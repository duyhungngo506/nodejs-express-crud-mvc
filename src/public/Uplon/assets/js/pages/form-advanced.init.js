!(function (n) {
    ...
    (a.prototype.initSwitchery = function () {
        ...
        (a.prototype.initMultiSelect = function () {
            n('[data-plugin="multiselect"]').multiSelect(n(this).data()),
                n('#my_multi_select3').multiSelect({
                    selectableHeader:
                    ...
                    afterInit: function (a) {
                        ...
                        (e.qs1 = n.quicksearch(t).on('keydown', function (a) {
                            if (40 === a.which)
                                return e.$selectableUl.focus(), !1;
                        })),
                            (e.qs2 = i
                                .quicksearch(o)
                                .on('keydown', function (a) {
                                    if (40 == a.which)
                                        return e.$selectionUl.focus(), !1;
                                }));
                    },
    ...
    $(function () {
        ...
        $.mockjax({
            ...
            response: function (a) {
                var e = a.data.query,
                    n = e.toLowerCase(),
                    i = new RegExp(
                        '\\b' + $.Autocomplete.utils.escapeRegExChars(n),
                        'gi',
                    ),
                    t = {
                        query: e,
        ...
        $('#autocomplete').devbridgeAutocomplete({
            ...
            onSelect: function (a) {
                $('#selection').html(
                    'You selected: ' + a.value + ', ' + a.data.category,
                );
            },
