!(function (e, t) {
    ...
    var p = (function (n) {
        ...
        (ae.attr = function (e, t) {
            ...
            var n = _.attrHandle[t.toLowerCase()],
                i =
                    n && I.call(_.attrHandle, t.toLowerCase())
                        ? n(e, t, !x)
                        : void 0;
            return void 0 !== i
                ? i
        ...
        function xe(e) {
            for (
                ...
                if ((t = _.relative[e[a].type])) c = [_e(we(c), t)];
                    ...
                    if (
                        (t = _.filter[e[a].type].apply(null, e[a].matches))[C]
                    ) {
    ...
    function Re(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            G.hasData(e) &&
                ((a = G.access(e)), (l = C.extend({}, a)), G.set(t, l));
        }
    }
    function qe(n, i, r, o) {
        i = g.apply([], i);
        ...
        if (
            ...
            if (a)
                for (
                    u = s[s.length - 1].ownerDocument, C.map(s, Pe), c = 0;
                    c < a;
                    c++
                )
                    (l = s[c]),
    ...
    C.extend({
        ...
        C.each(['height', 'width'], function (e, l) {
            C.cssHooks[l] = {
                get: function (e, t, n) {
                    if (t)
                        return !Ye.test(C.css(e, 'display')) ||
                            (e.getClientRects().length &&
            ...
            ajax: function (e, t) {
                ...
                function u(e, t, n, i) {
                    ...
                    p ||
                        ...
                        (E.statusText = (t || u) + ''),
                        r
                            ? b.resolveWith(v, [o, u, E])
                            : b.rejectWith(v, [E, u, s]),
                        E.statusCode(w),
                        (w = void 0),
                        g &&
    ...
    C.ajaxSetup({
        ...
        (v.createHTMLDocument =
            (((Kt = x.implementation.createHTMLDocument('').body).innerHTML =
                '<form></form><form></form>'),
    ...
    (function (e, t) {
        ...
        var le = 'collapse',
            ...
            Te = (function () {
                ...
                return (
                    ...
                    (e._getConfig = function (e) {
                        return (
                            ((e = l({}, de, e)).toggle = Boolean(e.toggle)),
            ...
            wt = (function () {
                function o(e, t) {
                    ...
                    !(function (e, t) {
                        ...
                        Object.keys(
                            Qe({}, o.Defaults.modifiers, i.modifiers),
                        ).forEach(function (e) {
        ...
        p(document)
            ...
            .on(Dt.KEYDOWN_DATA_API, qt, Yt._dataApiKeydownHandler)
                    ...
                    (i._jQueryInterface = function (n) {
                        return this.each(function () {
                            ...
                            if (
                                (e || !/dispose|hide/.test(n)) &&
                                (e ||
                                    ((e = new i(this, t)), p(this).data(Qn, e)),
                                'string' == typeof n)
                            ) {
                                if (void 0 === e[n])
                                    throw new TypeError(
            ...
            Ti = (function () {
                ...
                return (
                    ...
                    (e._activate = function (t) {
                        ...
                        n.hasClass(fi)
                            ? (n.closest(yi).find(_i).addClass(di),
                              n.addClass(di))
                            : (n.addClass(di),
                              n
                                  .parents(pi)
        ...
        p(window).on(ci.LOAD_DATA_API, function () {
            for (
                var e = [].slice.call(document.querySelectorAll(hi)),
                    t = e.length;
                t--;
            ...
            slimScroll: function (S) {
                ...
                return (
                    this.each(function () {
                        ...
                        if (d.parent().hasClass(A.wrapperClass)) {
                            ...
                            if (
                                ...
                                if ('scrollTo' in S) h = parseInt(A.scrollTo);
                                    ...
                                    return (
                                        b.remove(), y.remove(), void d.unwrap()
                                    );
                                E(h, !1, !0);
                            }
                            ...
                            if (
                                ...
                                (i =
                                    (a =
                                        parseInt(b.css('top')) /
                                        (d.outerHeight() - b.outerHeight())) *
                                    (d[0].scrollHeight - d.outerHeight())),
                                n)
                            ) {
                                var o =
                                    ((i = e) / d[0].scrollHeight) *
                                    d.outerHeight();
                        ...
                        function T() {
                            (s = Math.max(
                                (d.outerHeight() / d[0].scrollHeight) *
                                    d.outerHeight(),
                                c,
                            )),
                                b.css({ height: s + 'px' });
                    ...
                    (e.init = function () {
                        ...
                        e.addClass(i),
                            ...
                            e
                                .find(s.parentTrigger)
                                .children(s.triggerElement)
                                .on(c.CLICK_DATA_API, function (e) {
                                    var t = a(this);
        ...
        var h = {
                ...
                hide: function (e, t) {
                    for (
                        ...
                        o(e, t, n[i]);
                    a &&
                        (t.removeEventListener('touchend', h.hide),
            ...
            if (null !== n) {
                ...
                if ((u.registerEvent(t), 'touchstart' === t.type && h.delay)) {
                    var i = !1,
                        ...
                        o = function (e) {
                            r && (clearTimeout(r), (r = null), h.show(t, n)),
                                i || ((i = !0), h.hide(e, n)),
                                s();
                        },
                        e = function (e) {
                    ...
                    h.show(t, n),
                        a &&
                            (n.addEventListener('touchend', h.hide, !1),
        ...
        (n.prototype.add = function (e) {
            ...
            (n.prototype.createThrottledResizeHandler = function () {
                ...
                this.adapter.on('resize.waypoints', function () {
                    t.didResize ||
                        ((t.didResize = !0), m.requestAnimationFrame(e));
                });
            }),
                ...
                (e = {
                    ...
                    for (var s in this.waypoints[r]) {
                        ...
                        f.element !== f.element.window &&
                            ...
                            (c = !l && !u),
                            !g && l && u
                                ? (f.queueTrigger(o.backward),
                                  (i[f.group.id] = f.group))
                                : !g && c
                                ? (f.queueTrigger(o.forward),
                                  (i[f.group.id] = f.group))
                                : g &&
                    ...
                    function (e) {
                        !(function () {
                            ...
                            h.data('counterup-func', function () {
                                h.data('counterup-nums')
                                    ? (h.html(h.data('counterup-nums').shift()),
                                      h.data('counterup-nums').length
                                          ? setTimeout(
                                                h.data('counterup-func'),
                                                p.delay,
                                            )
                                          : (h.data('counterup-nums', null),
