    ...
    (b = window.Morris = {}),
            ...
            function d(b) {
                ...
                'static' === this.el.css('position') &&
                    ...
                    this.el.bind('mousemove', function (a) {
                        ...
                        return (
                            ...
                            c.selectFrom
                                ? ((b =
                                      c.data[
                                          c.hitTest(Math.min(g, c.selectFrom))
                                      ]._x),
                                  (e =
                                      c.data[
                                          c.hitTest(Math.max(g, c.selectFrom))
                                      ]._x),
                                  (f = e - b),
                    ...
                    this.el.bind('mouseleave', function () {
                        return (
                            c.selectFrom &&
                                (c.selectionRect.hide(), (c.selectFrom = null)),
                            c.fire('hoverout')
                        );
                    }),
            ...
            return (
                ...
                (d.prototype._calc = function () {
                    ...
                    return (
                        ...
                        (this.bottom =
                            this.elementHeight - this.options.padding),
                        ((g = this.options.axes) === !0 ||
                            'both' === g ||
                            'y' === g) &&
                            ((f = function () {
                                var a, c, d, e;
                                for (
                                    d = this.grid, e = [], a = 0, c = d.length;
                                    c > a;
                                    a++
                                )
                                    (b = d[a]),
        ...
        (b.Hover = (function () {
            function c(c) {
                null == c && (c = {}),
                    ...
                    (this.el = a(
                        "<div class='" + this.options['class'] + "'></div>",
                    )),
                    this.el.hide(),
        ...
        (b.Line = (function (a) {
            ...
            return (
                    ...
                    for (e = this.data, f = [], c = 0, d = e.length; d > c; c++)
                        (a = e[c]),
                            ...
                            (a._y = function () {
                                var c, d, e, f;
                                for (
                                    e = a.y, f = [], c = 0, d = e.length;
                                    d > c;
                                    c++
                                )
                                    (b = e[c]),
                                        null != b
                                            ? f.push(this.transY(b))
                                            : f.push(b);
                                return f;
                            }.call(this)),
                            f.push(
                ...
                (c.prototype.displayHoverForRow = function (a) {
                    var b;
                    return null != a
                        ? ((b = this.hover).update.apply(
                              b,
                              this.hoverContentForRow(a),
                          ),
                          this.hilight(a))
                            ...
                            (e =
                                ...
                                (a = function () {
                                    ...
                                    for (
                                        ...
                                        (d = e[a]),
                                            void 0 !== d._y[c] &&
                                                f.push({ x: d._x, y: d._y[c] });
                                    return f;
                                }.call(this)),
                                a.length > 1
                                    ? j.push(
                                          b.Line.createPath(a, e, this.bottom),
                                      )
                                    : j.push(null);
                        return j;
                    }.call(this));
                ...
                (c.prototype.drawSeries = function () {
                    ...
                    for (
                        this.seriesPoints = [],
                            a = b = d = this.options.ykeys.length - 1;
                        0 >= d ? 0 >= b : b >= 0;
                        a = 0 >= d ? ++b : --b
                    )
                        this._drawLineFor(a);
                    ...
                    if (null !== a && this.prevHilight !== a)
                        for (
                            ...
                            this.seriesPoints[b][a] &&
                                this.seriesPoints[b][a].animate(
                                    this.pointGrowSeries(b),
                                );
                    ...
                    return 'function' == typeof this.options.lineColors
                        ...
                        ? this.options.pointFillColors[
                          ...
                          this.options.lineColors[
                              b % this.options.lineColors.length
                          ]
                        : this.options.lineColors[
                              b % this.options.lineColors.length
                          ];
                ...
                (c.prototype.lineWidthForSeries = function (a) {
                    return this.options.lineWidth instanceof Array
                        ? this.options.lineWidth[
                              a % this.options.lineWidth.length
                          ]
                        : this.options.lineWidth;
                }),
                (c.prototype.pointSizeForSeries = function (a) {
                    return this.options.pointSize instanceof Array
                        ? this.options.pointSize[
                              a % this.options.pointSize.length
                          ]
                        : this.options.pointSize;
                }),
        ...
        (c = function (a) {
            return {
                ...
                fmt: function (a) {
                    return (
                        '' + b.pad2(a.getHours()) + ':' + b.pad2(a.getMinutes())
                    );
                },
                incr: function (b) {
        ...
        (b.LABEL_SPECS = {
            decade: {
                ...
                start: function (a) {
                    return new Date(
                        a.getFullYear() - (a.getFullYear() % 10),
                        0,
                        1,
                    );
                },
            ...
            month: {
                ...
                fmt: function (a) {
                    return (
                        '' + a.getFullYear() + '-' + b.pad2(a.getMonth() + 1)
                    );
                },
                incr: function (a) {
        ...
        (b.Area = (function (c) {
            ...
            return (
                ...
                (d.prototype.fillForSeries = function (a) {
                    ...
                    return (
                        (b = Raphael.rgb2hsl(
                            this.colorFor(this.data[a], a, 'line'),
                        )),
                        Raphael.hsl(
                            b.h,
                            this.options.behaveLikeLine
        ...
        (b.Bar = (function (c) {
            ...
            return (
                ...
                (d.prototype.calcBars = function () {
                    var a, b, c, d, e, f, g;
                    for (
                        f = this.data, g = [], a = d = 0, e = f.length;
                        e > d;
                        a = ++d
                    )
                        (b = f[a]),
                            (b._x =
                                this.left +
                                (this.width * (a + 0.5)) / this.data.length),
                            g.push(
                                (b._y = function () {
                                    var a, d, e, f;
                                    for (
                                        e = b.y, f = [], a = 0, d = e.length;
                                        d > a;
                                        a++
                                    )
                                        (c = e[a]),
                                            null != c
                                                ? f.push(this.transY(c))
                                                : f.push(null);
                                    return f;
                                }.call(this)),
                            );
                ...
                (d.prototype.drawXAxis = function () {
                    ...
                    for (
                        j =
                            this.bottom +
                            (this.options.xAxisLabelTopPadding ||
                        ...
                        (h = this.data[this.data.length - 1 - a]),
                            ...
                            0 !== this.options.xLabelAngle &&
                                ((e =
                                    ...
                                    i.width *
                                    Math.cos(
                                        (this.options.xLabelAngle * Math.PI) /
                                            180,
                                    )),
                                b.transform('t' + e + ',0...')),
                            (null == g ||
                ...
                (d.prototype.drawSeries = function () {
                    ...
                    return (
                        ...
                        (h = this.options.stacked
                            ? 1
                            : this.options.ykeys.length),
                        (a =
                            (c * this.options.barSizeRatio -
                                this.options.barGap * (h - 1)) /
                            h),
                        this.options.barSize &&
                            (a = Math.min(a, this.options.barSize)),
                ...
                (d.prototype.colorFor = function (a, b, c) {
                    ...
                    return 'function' == typeof this.options.barColors
                        ...
                        : this.options.barColors[
                              b % this.options.barColors.length
                          ];
                }),
                ...
                (d.prototype.onHoverMove = function (a) {
                    ...
                    return (
                        (b = this.hitTest(a)),
                        (c = this.hover).update.apply(
                            c,
                            this.hoverContentForRow(b),
                        )
                    );
                }),
                ...
                (d.prototype.hoverContentForRow = function (a) {
                    ...
                    return (
                        ...
                        (e =
                            this.left +
                            ((a + 0.5) * this.width) / this.data.length),
                        [b, e]
                    );
                }),
            ...
            return (
                ...
                (d.prototype.select = function (a) {
                    ...
                    return (
                        ...
                        this.setLabels(
                            b.label,
                            this.options.formatter(b.value, b),
                        )
                    );
                }),
