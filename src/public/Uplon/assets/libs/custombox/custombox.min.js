            ...
            function e(n) {
                _classCallCheck(this, e),
                    ...
                    (this.element.style.borderColor =
                        this.options.loader.background),
                    (this.element.style.borderTopColor =
                        this.options.loader.color),
                    (this.element.style.animationDuration =
                        this.options.loader.speed + 'ms'),
            ...
            return (
                _createClass(e, [
                    ...
                    },
                    {
                        key: 'destroy',
                        value: function () {
                            this.element.parentElement.removeChild(
                                this.element,
                            );
                        },
                    },
        ...
        v = (function () {
            function e(n) {
                if (
                    ...
                    throw new Error(
                        'You need to instantiate Custombox when the document is fully loaded',
                    );
                ...
                this.element.classList.add(t + '-container'),
                    this.element.classList.add(
                        t + '-' + this.options.content.effect,
                    ),
                    (this.element.style.animationDuration =
                        this.options.content.speedIn + 'ms'),
                            ...
                            if (!e.length)
                                if (n)
                                    for (
                                        ...
                                        i[s].startsWith(t + '-') &&
                                            this.element.classList.remove(i[s]);
                                else {
                                    for (
                        ...
                        value: function () {
                            try {
                                this.element.parentNode.removeChild(
                                    ...
                                    this.style.parentNode.removeChild(
                                        this.style,
                                    );
                            } catch (e) {}
                        },
                            ...
                            if (
                                (u.check(a, this.options.content.effect)
                                    ? ((this.element.style.opacity =
                                          this.options.overlay.opacity.toString()),
                                      (this.element.style.animationDuration =
                                          this.options.overlay.speedIn + 'ms'),
                                ...
                                u.check(h, this.options.content.effect) &&
                                    (o = this.options.content.speedIn),
                                    (this.element.style.animationDuration =
                                        o + 'ms');
                            }
                        },
                                        ...
                                        (d.onload = function () {
                                            if (200 === d.status) {
                                                ...
                                                try {
                                                    ...
                                                    o(
                                                        new Error(
                                                            'The ajax response need a wrapper element',
                                                        ),
                                                    );
                                                }
                                                e.options.content.width &&
                                    ...
                                    u
                                        ? (e.options.content.clone
                                              ...
                                              : ((e.reference =
                                                ...
                                                e.reference.classList.add(
                                                    t + '-reference',
                                                ),
                                                e.reference.setAttribute(
                                                    'style',
                ...
                _createClass(
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            value: function () {
                                this.options.loader.active &&
                                    (this.loader = new f(this.options)),
                                    u.check(c, this.options.content.effect) &&
                                        (this.container = new v(this.options)),
                                    this.options.overlay.active &&
                                        (this.overlay = new y(this.options)),
                                ...
                                document.addEventListener(
                                    ...
                                    function () {
                                        window
                                            ...
                                            ? (e.content.element.style.animationFillMode =
                                                  'backwards')
                                            : (e.content.element.style.animationFillMode =
                                                  n);
                                    },
