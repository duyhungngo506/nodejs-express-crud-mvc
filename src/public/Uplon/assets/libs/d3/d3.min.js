...
!(function (t, n) {
            ...
            for (
                ...
                for (
                    ...
                    (o = u[s]) &&
                        ...
                        ('__data__' in o && (a.__data__ = o.__data__),
                        (f[s] = a));
        ...
        selectAll: function (t) {
            ...
            for (
                ...
                for (var a, u = n[o], c = u.length, f = 0; f < c; ++f)
                    (a = u[f]) &&
                        (r.push(t.call(a, a.__data__, f, u)), i.push(a));
            return new Pt(r, i);
        },
        filter: function (t) {
    ...
    function On(t) {
        ...
        return (
            r === i && i === o
                ? (n = e = a)
                : ((n = Fn(
                      (0.4360747 * r + 0.3850649 * i + 0.1430804 * o) / Pn,
                  )),
                  (e = Fn(
                      (0.0139322 * r + 0.0971045 * i + 0.7141733 * o) / Rn,
                  ))),
    ...
    var ui = (function t(n) {
        ...
        hi = (function t(n, e) {
            ...
            function i(t) {
                return (
                    1 - n * Math.pow(2, -10 * (t = +t)) * Math.sin((t + r) / e)
                );
            }
            return (
                (i.amplitude = function (n) {
            ...
            function i(t) {
                return (
                    ((t = 2 * t - 1) < 0
                        ...
                        : 2 -
                          n * Math.pow(2, -10 * t) * Math.sin((r + t) / e)) / 2
                );
            }
            return (
                (i.amplitude = function (n) {
    ...
    function Yi(n) {
        ...
        function d() {
            ...
            function F() {
                ...
                !R ||
                    g ||
                    y ||
                    (Math.abs(t[0] - L[0]) > Math.abs(t[1] - L[1])
                        ? (y = !0)
                        : (g = !0)),
                    (L = t),
                    (v = !0),
        ...
        return (
            ...
            (h.prototype = {
                ...
                emit: function (t) {
                    kt(
                        new _i(f, t, n.output(this.state.selection)),
                        u.apply,
                        u,
    ...
    function Bo(t) {
        ...
        function r(t, n) {
            ...
            for (
                t.charCodeAt(o - 1) === Ro && --o,
                    t.charCodeAt(o - 1) === Do && --o;
                (r = s()) !== Po;
    ...
    (ba.copy = function () {
        ...
        (ba.visitAfter = function (t) {
            ...
            for (
                this._root &&
                e.push(
                    new da(this._root, this._x0, this._y0, this._x1, this._y1),
                );
                (n = e.pop());
    ...
    var qa = {
        ...
        s: function (t, n) {
            ...
            var r = e[0],
                ...
                o =
                    i -
                    (Ca = 3 * Math.max(-8, Math.min(8, Math.floor(i / 3)))) +
                    1,
                a = r.length;
            return o === a
                ? r
        ...
        function l(t) {
            ...
            function M(t) {
                ...
                switch (
                    (v &&
                        d &&
                        ((t = r(T + t, T.length ? p - M.length : 1 / 0)),
                        (T = '')),
                    e)
                ) {
                    case '<':
    ...
    function Ha(t, n) {
        return Math.max(
            0,
            3 * Math.max(-8, Math.min(8, Math.floor(Ea(n) / 3))) -
                Ea(Math.abs(t)),
        );
    }
    function ja(t, n) {
        ...
        return function (a) {
            var c,
                ...
                x = {
                    ...
                    lineEnd: function () {
                        c &&
                            (M(l, h), d && g && m.rejoin(), c.push(m.result()));
    ...
    var Lf,
        ...
        If = {
            ...
            polygonEnd: function () {
                (If.lineStart = If.lineEnd = If.point = _u),
                    Yf.add(ru(Ff)),
                    Ff.reset();
            },
            result: function () {
        ...
        return [
            ...
            n *
                (1.007226 +
                    e *
                        (0.015085 +
                            r * (0.028874 * e - 0.044475 - 0.005916 * r))),
        ];
    }
    function gl(t, n) {
    ...
    var dh = (function t(n) {
        function e(t, e, r, i, o) {
            if ((a = t._squarify) && a.ratio === n)
                for (
                    var a, u, c, f, s, l = -1, h = a.length, d = t.value;
                    ++l < h;
    ...
    function Yh() {
        ...
        function s() {
            return (
                (r = Math.min(a.length, u.length) > 2 ? Oh : Uh),
                (i = o = null),
                l
            );
        }
        ...
        bd = cd(
            ...
            function (t, n) {
                return (
                    (n -
                        t -
                        (n.getTimezoneOffset() - t.getTimezoneOffset()) * ld) /
                    864e5
                );
            },
            function (t) {
        ...
        var n = t.dateTime,
            ...
            x = {
                a: function (t, n, e) {
                    ...
                    return r
                        ? ((t.w = p[r[0].toLowerCase()]), e + r[0].length)
                        : -1;
                },
                A: function (t, n, e) {
                    var r = l.exec(n.slice(e));
                    return r
                        ? ((t.w = h[r[0].toLowerCase()]), e + r[0].length)
                        : -1;
                },
                b: function (t, n, e) {
                    var r = y.exec(n.slice(e));
                    return r
                        ? ((t.m = _[r[0].toLowerCase()]), e + r[0].length)
                        : -1;
                },
                B: function (t, n, e) {
                    var r = v.exec(n.slice(e));
                    return r
                        ? ((t.m = g[r[0].toLowerCase()]), e + r[0].length)
                        : -1;
                },
                c: function (t, e, r) {
                    return N(t, n, e, r);
                ...
                p: function (t, n, e) {
                    ...
                    return r
                        ? ((t.p = s[r[0].toLowerCase()]), e + r[0].length)
                        : -1;
                },
                Q: Fp,
                s: Ip,
            ...
            point: function (t, n) {
                ...
                if (((n = +n), (t = +t) !== this._x1 || n !== this._y1)) {
                    switch (this._point) {
                        ...
                        case 2:
                            (this._point = 3),
                                H_(this, I_(this, (e = F_(this, t, n))), e);
                            break;
                        default:
    ...
    function Yb(t, n) {
        var e,
            ...
            o = t.sort(Bb).pop();
        for (
            qb = [], Rb = new Array(t.length), zb = new ab(), Db = new ab();
            ;
            ...
            !(function (t, n, e, r) {
                ...
                (function (t, n, e, r) {
                    ...
                    for (i = 0; i < g; ++i)
                        if ((o = Rb[i])) {
                            for (
                                a = o.site, u = (c = o.halfedges).length;
                                u--;
    ...
    (Xb.prototype = Hb.prototype),
        ...
        (t.contourDensity = function () {
            ...
            return (
                ...
                (l.bandwidth = function (t) {
                    ...
                    return (
                        (o = Math.round((Math.sqrt(4 * t * t + 1) - 1) / 2)),
                        y()
                    );
                }),
                l
                    ...
                    for (u = 0, i = new Array(f); u < s; ++u)
                        ((c = t[u]).index = u),
                            'object' != typeof c.source &&
                                (c.source = Ma(l, c.source)),
                            'object' != typeof c.target &&
                                (c.target = Ma(l, c.target)),
        ...
        (t.geoCentroid = function (t) {
            (tc = nc = ec = rc = ic = oc = ac = uc = cc = fc = sc = 0),
                Nu(t, kc);
            var n = cc,
                e = fc,
                r = sc,
        ...
        (t.geoCircle = function () {
            ...
            return (
                (a.center = function (t) {
                    return arguments.length
                        ? ((e =
                              'function' == typeof t ? t : Bc([+t[0], +t[1]])),
                          a)
                        : e;
                }),
                (a.radius = function (t) {
        ...
        (t.histogram = function () {
            ...
            return (
                ...
                (r.domain = function (t) {
                    return arguments.length
                        ? ((n = 'function' == typeof t ? t : p([t[0], t[1]])),
                          r)
                        : n;
                }),
        ...
        (t.pie = function () {
            ...
            function a(a) {
                var u,
                    ...
                    y = Math.min(
                        Ay,
                        Math.max(-Ay, i.apply(this, arguments) - g),
                    ),
        ...
        (t.stack = function () {
            ...
            function i(i) {
                ...
                for (o = 0; o < f; ++o) {
                    for (
                        var l, h = u[o], d = (s[o] = new Array(c)), p = 0;
                        p < c;
                        ++p
                    )
        ...
        (t.stackOffsetDiverging = function (t, n) {
            if ((u = t.length) > 0)
                for (
                    var e, r, i, o, a, u, c = 0, f = t[n[0]].length;
                    c < f;
                    ++c
                )
                    for (o = a = 0, e = 0; e < u; ++e)
        ...
        (t.thresholdScott = function (t, n, e) {
            return Math.ceil(
                (e - n) / (3.5 * f(t) * Math.pow(t.length, -1 / 3)),
            );
        }),
        ...
        (t.tree = function () {
            ...
            function i(i) {
                var c = (function (t) {
                    for (
                        var n, e, r, i, o, a = new ch(t, 0), u = [a];
                        (n = u.pop());
                        ...
                        if ((r = n._.children))
                            for (
                                ...
                                u.push((e = n.children[i] = new ch(r[i], i))),
                                    (e.parent = n);
                ...
                if (r.apply(this, arguments)) {
                    var t = x(this, arguments),
                        ...
                        e = Math.max(
                            ...
                            Math.min(
                                c[1],
                                n.k * Math.pow(2, a.apply(this, arguments)),
                            ),
                        ),
                        i = Bt(this);
                    if (t.wheel)
                    ...
                    Vb(),
                        ...
                        t.zoom(
                            'mouse',
                            o(_(y(n, e), t.mouse[0], t.mouse[1]), t.extent, f),
                        );
                }
            }
            function N() {
                ...
                if (r.apply(this, arguments)) {
                    var e,
                        ...
                        f = x(
                            this,
                            arguments,
                            t.event.changedTouches.length === c,
                        );
                    for (Gb(), i = 0; i < c; ++i)
                        (a = [
            ...
            function S() {
                if (this.__zooming) {
                    var e,
                        ...
                        s = c.length;
                    for (
                        Vb(), n && (n = clearTimeout(n)), u.taps = 0, e = 0;
                        e < s;
                        ++e
                    )
                    ...
                    for (
                        ...
                        (r = o[n]),
                            i.touch0 && i.touch0[2] === r.identifier
                                ? delete i.touch0
                                : i.touch1 &&
                                  i.touch1[2] === r.identifier &&
                                  delete i.touch1;
                    if (
                        (i.touch1 &&
                            !i.touch0 &&
                            ((i.touch0 = i.touch1), delete i.touch1),
                        i.touch0)
                    )
