...
!(function (t, i, e, n) {
    var a = (t.fn.peity = function (i, e) {
        ...
        s = (h.svgElement = function (e, n) {
            return t(i.createElementNS('http://www.w3.org/2000/svg', e)).attr(
                n,
            );
        }),
    ...
    (h.draw = function () {
        ...
        (h.prepare = function (t, i) {
            return (
                this.$svg ||
                    this.$el
                        .hide()
                        .after((this.$svg = s('svg', { class: 'peity' }))),
                this.$svg
                    .empty()
                    .data('_peity', this)
        ...
        (h.values = function () {
            return t.map(
                this.$el.text().split(this.opts.delimiter),
                function (t) {
                    return parseFloat(t);
                },
            );
        ...
        a.register(
            ...
            function (t) {
                ...
                g.push(p, d),
                    t.fill &&
                        h.append(
                            s('polygon', { fill: t.fill, points: g.join(' ') }),
                        ),
                    l &&
                        h.append(
                            s('polyline', {
