    ...
    (a.quicksearch = {
        ...
        (a.fn.quicksearch = function (c, d) {
            this.removeDiacritics = function (b) {
                for (
                    var c = a.quicksearch.diacriticsRemovalMap, d = 0;
                    d < c.length;
                    d++
                )
                    b = b.replace(c[d].letters, c[d].base);
                return b;
            };
            var e,
                f,
            ...
            return (
                (l.noResults = l.noResults ? a(l.noResults) : a()),
                (l.loader = l.loader ? a(l.loader) : a()),
                (this.go = function () {
                    var b,
                        c = 0,
                        d = 0,
                    ...
                    for (
                        l.removeDiacritics && (i = k.removeDiacritics(i)),
                            b = l.prepareQuery(i),
                            c = 0,
                            d = g.length;
                        c < d;
                        ...
                        b.length > 0 && b[0].length < l.minValLength
                            ? (l.show.apply(g[c]), (h = !1), e++)
                            : m || l.testQuery(b, f[c], g[c])
                            ? (l.show.apply(g[c]), (h = !1), e++)
                            : l.hide.apply(g[c]);
                    return (
                        h
                            ? a.isFunction(l.onNoResultFound)
                                ? l.onNoResultFound(this)
                                : this.results(!1)
                            : (this.results(!0), this.stripe()),
                ...
                (this.strip_html = function (b) {
                    ...
                    return (
                        l.caseSensitive || (c = c.toLowerCase()),
                        (c = a.trim(c))
                    );
                }),
                (this.results = function (a) {
                    return (
                        l.noResults.length &&
                            l.noResults[a ? 'hide' : 'show'](),
                        this
                    );
                }),
                (this.loader = function (a) {
                    return (
                        l.loader.length && l.loader[a ? 'show' : 'hide'](), this
                    );
                }),
                (this.cache = function (b) {
                    return (
                        (b = 'undefined' == typeof b || b),
                        (h = a(c).not(l.noResults)),
                        (f =
                            'string' == typeof l.selector
                                ? h.map(function () {
                                      return a(this)
                                          .find(l.selector)
                                          .map(function () {
                                              ...
                                              return l.removeDiacritics
                                                  ? k.removeDiacritics(a)
                                                  : a;
                                          })
                                          .get()
                                          .join(' ');
                ...
                (this.trigger = function () {
                    return (
                        (i.length < l.minValLength && i.length > j.length) ||
                        (i.length < l.minValLength - 1 && i.length < j.length)
                            ? (l.onValTooSmall.call(this, i), k.go())
                            : (this.loader(!0),
                              l.onBefore.call(this),
                              b.clearTimeout(e),
                              (e = b.setTimeout(function () {
