!(function (a, b) {
    ...
    function c(c) {
        ...
        try {
            ...
            if (1 === a('parsererror', d).length)
                throw new Error('Error: ' + a(d).text());
            return d;
        } catch (b) {
        ...
        return (
            a.each(b, function (e) {
                ...
                'object' == typeof c[e] && null !== c[e]
                    ? (f &&
                          a.isArray(c[e]) &&
                          (f = a.isArray(b[e]) && c[e].length === b[e].length),
                      (f = f && d(b[e], c[e])))
                    : (f =
                          b[e] && a.isFunction(b[e].test)
                              ? f && b[e].test(c[e])
                              : f && b[e] === c[e]);
            }),
            f
    ...
    function g(b, c) {
        ...
        if (a.isFunction(b.url.test)) {
            ...
            var e = b.url,
                f =
                    b.namespace ||
                    (void 0 === b.namespace && a.mockjaxSettings.namespace);
            if (f) {
    ...
    function l(a, b, c) {
        if (
            (m(a),
            (a.dataType = 'json'),
            (a.data && z.test(a.data)) || z.test(a.url))
        ) {
            p(a, b, c);
            var d = /^(\w+:)?\/\/([^\/?#]+)/,
                e = d.exec(a.url),
                f =
                    e &&
                    ((e[1] && e[1] !== location.protocol) ||
                        e[2] !== location.host);
            if (
                ((a.dataType = 'script'), 'GET' === a.type.toUpperCase() && f)
            ) {
                var g = n(a, b, c);
                return g || !0;
            }
    ...
    function n(b, c, d) {
        ...
        if (c.response && a.isFunction(c.response)) c.response(d);
            ...
            if (c.proxy)
                return (
                    C.info(c, [
                        'Performing JSONP proxy request: ' + c.proxy,
                        c,
                    ]),
                    v({
                        global: !1,
                        ...
                        data: c.data,
                        dataType:
                            'script' === b.dataType ? 'text/plain' : b.dataType,
                        complete: function (d) {
                            a.globalEval('(' + d.responseText + ')'),
                                o(b, c, e, f);
                        },
                    }),
                    f
    ...
    function p(a, c, d) {
        var e = (d && d.context) || a,
            f =
                ('string' == typeof a.jsonpCallback && a.jsonpCallback) ||
                'jsonp' + A++;
    ...
    function q(b, c, d) {
        b.success && b.success.call(c, d.responseText || '', 'success', {}),
            b.global &&
                (b.context ? a(b.context) : a.event).trigger('ajaxSuccess', [
                    {},
                    b,
                ]);
    }
    function r(b, c) {
        b.complete &&
            ...
            b.global &&
                (b.context ? a(b.context) : a.event).trigger('ajaxComplete', [
                    {},
                    b,
                ]),
    ...
    function s(b, c) {
        ...
        for (var i = 0; i < w.length; i++) {
            var j = a.mockjaxSettings.matchInRegistrationOrder
                    ? i
                    : w.length - 1 - i,
                m = w[j];
            if (m) {
                if ((f = g(m, e))) {
                    if (
                        ...
                        C.info(f, [
                            'MOCK ' + e.type.toUpperCase() + ': ' + e.url,
                            a.ajaxSetup({}, e),
                        ]),
                        (301 === f.status || 302 === f.status) &&
                            ('GET' === e.type.toUpperCase() ||
                                'HEAD' === e.type.toUpperCase()) &&
                            f.headers.Location)
                    ) {
                        C.debug(
                            'Doing mock redirect to',
                            f.headers.Location,
                            e.type,
                        );
                        for (
                            var n = {}, o = Object.keys(c), p = 0;
                            p < o.length;
                            p++
                        )
                            n[o[p]] = c[o[p]];
                        return (
                            (n.url = f.headers.Location),
                            (n.headers = { Referer: c.url }),
                            s(n)
                        );
                    }
                    return e.dataType &&
                        'JSONP' === e.dataType.toUpperCase() &&
                        (d = l(e, f, c))
                        ? d
                        : ((c.crossDomain = !1),
                          (f.cache = e.cache),
                          ...
                          a.isFunction(f.onAfterSuccess) &&
                              (c.success = h('Success', f)),
                          a.isFunction(f.onAfterError) &&
                              (c.error = h('Error', f)),
                          a.isFunction(f.onAfterComplete) &&
                              (c.complete = h('Complete', f)),
                          t(f, c),
                          (function (b, c, e, f) {
                              d = v.call(
                                  a,
    ...
    function u(a) {
        ...
        for (b = 0, c = w.length; b < c; b++)
            (d = w[b]),
                f(d.url)
                    ? C.log(d, ['Clearing mock: ' + (d && d.url), d])
                    : e.push(d);
        return e;
    }
    var v = a.ajax,
                ...
                if (
                    ...
                    return a.mockjaxSettings.log
                        ...
                        : a.mockjaxSettings.logger &&
                          a.mockjaxSettings.logger[
                              a.mockjaxSettings.logLevelMethods[d]
                          ]
                        ? a.mockjaxSettings.logger[
                              a.mockjaxSettings.logLevelMethods[d]
                          ].apply(a.mockjaxSettings.logger, c)
                        : void 0;
            },
            debug: function (a, b) {
    ...
    return (
        ...
        (a.mockjax.clear = function (a) {
            'string' == typeof a || a instanceof RegExp
                ? (w = u(a))
                : a || 0 === a
                ? (C.log(w[a], ['Clearing mock: ' + (w[a] && w[a].url), w[a]]),
                  (w[a] = null))
