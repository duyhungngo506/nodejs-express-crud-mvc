...
!(function (t, e) {
        ...
        (f.prototype.getXAxis = function (t, e, i, n, r, a, o) {
            ...
            return (
                ...
                s.isCategorized() &&
                    ...
                    h(c.axis_x_tick_culling) && (c.axis_x_tick_culling = !1)),
                l
            );
        }),
            ...
            return (
                (e && o.currentMaxTickWidths[t]) ||
                    ...
                    (o.currentMaxTickWidths[t] =
                        s <= 0 ? o.currentMaxTickWidths[t] : s)),
                o.currentMaxTickWidths[t]
            );
        }),
    ...
    function x(t) {
        return (
            t / Math.pow(10, Math.ceil(Math.log(t) / Math.LN10 - 1e-12)) == 1
        );
    }
    (l.prototype.beforeInit = function () {}),
        ...
        (l.prototype.redraw = function (t, e) {
            var i,
                ...
                z = O.getShapeIndices(O.isLineType),
                M = O.hasArcType(),
            ...
            (f = O.generateDrawArea ? O.generateDrawArea(F, !1) : void 0),
                ...
                (x = O.generateDrawLine ? O.generateDrawLine(z, !1) : void 0),
                (y = O.generateXYForText(F, X, z, !0)),
                (m = O.generateXYForText(F, X, z, !1)),
                O.updateCircleY(),
                ...
                O.redrawSubchart && O.redrawSubchart(n, e, S, w, F, X, z),
                O.isStanfordGraphType() && O.drawColorScale(),
                ...
                i.forEach(function (i) {
                    ...
                    l.isCustomX() || l.isTimeSeries()
                        ? 0 <= r.indexOf(e)
                            ...
                            : C(u.data_xs) &&
                              (l.data.xs[i] = l.getXValuesOfXKey(
                                  e,
                                  l.data.targets,
                              ))
        ...
        (l.prototype.isStackNormalized = function () {
            return (
                this.config.data_stack_normalize &&
                0 < this.config.data_groups.length
            );
        }),
        ...
        (l.prototype.findClosest = function (t, i) {
            ...
            return (
                ...
                t
                    ...
                    .forEach(function (t) {
                        var e = r.config.tooltip_horizontal
                            ? r.horizontalDistance(t, i)
                            : r.dist(t, i);
                        e < a && ((a = e), (n = t));
                    }),
                n
        ...
        (l.prototype.loadFromArgs = function (e) {
            ...
            i.resetCache(),
                e.data
                    ...
                    : e.rows
                    ? i.load(
                          i.convertDataToTargets(i.convertRowsToData(e.rows)),
                          e,
                      )
                    : e.columns
                    ? i.load(
                          i.convertDataToTargets(
                              i.convertColumnsToData(e.columns),
                          ),
                          e,
                      )
                    : i.load(null, e);
            ...
            return (
                ...
                0 === _.length
                    ...
                    : (isNaN(m) && (m = 0),
                      ...
                      void 0 !== w &&
                          ((S = w + (d = Math.max(Math.abs(m), Math.abs(S)))),
                          (m = w - d)),
                      T
                          ...
                          : A &&
                            ...
                            (s += n.axis.convertPixelsToAxisPadding(l[1], o)),
                            (c += n.axis.convertPixelsToAxisPadding(l[0], o))),
                      'y' === e &&
                          C(r.axis_y_padding) &&
                          ((s = n.axis.getPadding(
                              r.axis_y_padding,
        ...
        (l.prototype.isWithinBar = function (t, e) {
            if (e.pathSegList.numberOfItems < 2) return !1;
            var i = u(e),
        ...
        (l.prototype.getShapeOffset = function (t, d, e) {
            var l = this,
                i = l.orderTargets(
                    l.filterTargetsToShow(l.data.targets.filter(t, l)),
                ),
                u = i.map(function (t) {
                    return t.id;
                });
        ...
        (l.prototype.updateCircle = function (t, e) {
            var i = this,
                ...
                r = n
                    ...
                    .attr(
                        'shape-rendering',
                        i.isStanfordGraphType() ? 'crispEdges' : '',
                    )
                    ...
                    .style(
                        ...
                        i.isStanfordGraphType()
                            ? i.getStanfordPointColor.bind(i)
                            : i.color,
                    );
            (i.mainCircle = r
                .merge(n)
                .style(
                    ...
                    i.isStanfordGraphType()
                        ? 1
                        : i.initialOpacityForCircle.bind(i),
                )),
        ...
        (l.prototype.redrawCircle = function (t, e, i, n) {
            ...
            return [
                (i ? r.mainCircle.transition(n) : r.mainCircle)
                    ...
                    .style(
                        'color',
                        r.isStanfordGraphType()
                            ? r.getStanfordPointColor.bind(r)
                            : r.color,
                    )
                    .attr('cx', t)
                    .attr('cy', e),
        ...
        (l.prototype.drawColorScale = function () {
            var t,
                ...
                l = s.data.targets[0];
            if (
                ((t = isNaN(d.stanford_scaleWidth)
                    ? 20
                    : d.stanford_scaleWidth),
                5,
                t < 0)
            )
                throw Error(
            ...
            (o = s.height - d.stanford_padding.bottom - d.stanford_padding.top),
                ...
                (a = c
                    .scaleSequential(l.colors)
                    .domain([i[i.length - 1], i[0]])),
                ...
                g(d.stanford_scaleValues) &&
                    n.tickValues(
                        d.stanford_scaleValues(l.minEpochs, l.maxEpochs),
                    ),
                (e = s.colorScale
                    .append('g')
                ...
                s.colorScale.attr(
                    'transform',
                    'translate('.concat(
                        s.currentWidth - s.xForColorScale(),
                        ', 0)',
                    ),
                );
        }),
        (l.prototype.xForColorScale = function () {
            return (
                this.config.stanford_padding.right +
                u(this.colorScale.node()).width
            );
        }),
        (l.prototype.getColorScalePadding = function () {
            return (
                this.xForColorScale() + this.config.stanford_padding.left + 20
            );
        }),
        ...
        (l.prototype.initStanfordData = function () {
            ...
            if (
                ...
                (i = isNaN(r.stanford_scaleMin)
                    ? n.min(t)
                    : r.stanford_scaleMin),
                (e = isNaN(r.stanford_scaleMax)
                    ? n.max(t)
                    : r.stanford_scaleMax) < i)
            )
                throw Error(
                    'Number of minEpochs has to be smaller than maxEpochs',
                );
    ...
    return (
        ...
        (l.prototype.updateStanfordElements = function (t) {
            ...
            (i = (e = c
                ...
                (r = (n = c
                    ...
                    .attr('class', function (t) {
                        return (
                            Y.stanfordRegion + (t.class ? ' ' + t.class : '')
                        );
                    }))
                    .append('polygon')
        ...
        (l.prototype.isScatterOrStanfordType = function (t) {
            return this.isScatterType(t) || this.isStanfordType(t);
        }),
