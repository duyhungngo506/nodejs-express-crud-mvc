...
!(function (a, b) {
    ...
    return (
            ...
            (b.namespaces = {
                ...
                (b.normalizeData = function (a, c, d) {
                    ...
                    return (
                        ...
                        Array.prototype.push.apply(
                            ...
                            b
                                .times(
                                    Math.max(0, e - f.normalized.labels.length),
                                )
                                .map(function () {
                                    return '';
                                }),
                ...
                (b.reverseData = function (a) {
                    ...
                    for (var b = 0; b < a.series.length; b++)
                        'object' == typeof a.series[b] &&
                        void 0 !== a.series[b].data
                            ? a.series[b].data.reverse()
                            : a.series[b] instanceof Array &&
                              a.series[b].reverse();
                }),
                    ...
                    return (
                        ...
                        'number' == typeof a
                            ...
                            : {
                                  ...
                                  right:
                                      'number' == typeof a.right ? a.right : b,
                                  bottom:
                ...
                (b.getHighLow = function (a, c, d) {
                    ...
                    var f = {
                            high:
                                void 0 === c.high ? -Number.MAX_VALUE : +c.high,
                    ...
                    if (e && b.projectLength(a, 1, k) >= d) k.step = 1;
                        ...
                        for (;;) {
                            if (m && b.projectLength(a, k.step, k) <= d)
                                ...
                                if (
                                    m ||
                                    !(b.projectLength(a, k.step / 2, k) >= d)
                                )
                                    break;
                        ...
                        void 0 === b.getMultiValue(c[h / 2].value)
                            ...
                            : (d.increasingX &&
                              ...
                              g &&
                                  ...
                                  (g = !1)),
                              f[f.length - 1].pathCoordinates.push(
                                  a[h],
                                  a[h + 1],
                              ),
                        ...
                        if (h.length) {
                            if (h.length > 1) {
                                ...
                                return (
                                    h.forEach(function (a) {
                                        i.push(
                                            f(a.pathCoordinates, a.valueData),
                                        );
                                    }),
                                    b.Svg.Path.join(i)
                                );
                            ...
                            for (
                                ...
                                j
                                    ...
                                    : l || (n[0] = { x: +c[l], y: +c[l + 1] }),
                                    k.curve(
                                        (d * (-n[0].x + 6 * n[1].x + n[2].x)) /
                                            6 +
                                            e * n[2].x,
                                        (d * (-n[0].y + 6 * n[1].y + n[2].y)) /
                                            6 +
                                            e * n[2].y,
                                        (d * (n[1].x + 6 * n[2].x - n[3].x)) /
                                            6 +
                                            e * n[2].x,
                                        (d * (n[1].y + 6 * n[2].y - n[3].y)) /
                                            6 +
                                            e * n[2].y,
                                        n[2].x,
                                        n[2].y,
            ...
            function h(a, c, d, e, f) {
                (this.container = b.querySelector(a)),
                    ...
                    (this.supportsForeignObject =
                        b.Svg.isSupported('Extensibility')),
        ...
        (function (a, b) {
            ...
            function c(a, c, d, e, f) {
                a instanceof Element
                    ...
                    : ((this._node = y.createElementNS(b.namespaces.svg, a)),
                      'svg' === a &&
                          this.attr({ 'xmlns:ct': b.namespaces.ct })),
                    c && this.attr(c),
                    d && this.addClass(d),
                    e &&
                        (f && e._node.firstChild
                            ? e._node.insertBefore(
                                  this._node,
                                  e._node.firstChild,
                              )
            ...
            function o(a) {
                return (
                    this._node.parentNode.replaceChild(a._node, this._node), a
                );
            }
            function p(a, b) {
                return (
            ...
            (b.Svg.Easing = z),
                (b.Svg.List = b.Class.extend({ constructor: x }));
        })(this, a),
        (function (a, b) {
            'use strict';
            ...
            function f(a) {
                return void 0 !== a
                    ? ((this.pos = Math.max(
                          0,
                          Math.min(this.pathElements.length, a),
                      )),
                      this)
                    : this.pos;
            }
        ...
        (function (a, b) {
            ...
            function d(a) {
                return (
                    (this.axisLength *
                        (+b.getMultiValue(a, this.units.pos) -
                            this.bounds.min)) /
                    this.bounds.range
                );
            }
        ...
        (function (a, b) {
            ...
            function c(a, c, d, e) {
                ...
                (this.divisor = e.divisor || 1),
                    ...
                    b.FixedScaleAxis['super'].constructor.call(
                        this,
                        a,
                        d,
                        this.ticks,
                ...
                (d =
                    ...
                    (f =
                        void 0 === a.axisY.type
                            ? new b.AutoScaleAxis(
                                  ...
                                  j,
                                  b.extend({}, a.axisY, {
                                      high: b.isNumeric(a.high)
                                          ? a.high
                                          : a.axisY.high,
                                      low: b.isNumeric(a.low)
                                          ? a.low
                                          : a.axisY.low,
                                  }),
                              )
                    ...
                    c.raw.series.forEach(
                        function (e, g) {
                            ...
                            var m = {
                                    lineSmooth: b.getSeriesOption(
                                        e,
                                        a,
                                        'lineSmooth',
                                    ),
                                    showPoint: b.getSeriesOption(
                                        e,
                                        a,
                                        'showPoint',
                                    ),
                                    showLine: b.getSeriesOption(
                                        e,
                                        a,
                                        'showLine',
                                    ),
                                    showArea: b.getSeriesOption(
                                        e,
                                        a,
                                        'showArea',
                                    ),
                                    areaBase: b.getSeriesOption(
                                        e,
                                        a,
                                        'areaBase',
                                    ),
            ...
            function c(a) {
                ...
                a.distributeSeries
                    ? ((c = b.normalizeData(
                      ...
                      (c.normalized.series = c.normalized.series.map(function (
                          a,
                      ) {
                          return [a];
                      })))
        ...
        (function (a, b) {
            ...
            function d(a) {
                ...
                '%' === m.unit && (m.value *= g / 100),
                    ...
                    (h =
                        'outside' === a.labelPosition ||
                        (a.donut && !a.donutSolid)
                            ? g
                        ...
                        function (e, f) {
                            if (
                                ...
                                a.donut &&
                                    ...
                                    a.donutSolid &&
                                        (x = a.classNames.sliceDonutSolid));
                                var y = k[f].elem(
                                    'path',
                                    { d: w.stringify() },
                                    x,
