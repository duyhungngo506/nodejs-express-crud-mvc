    ...
    var methods = {
        ...
        _bindClick: function () {
            ...
            self.stars.on('click.raty', function (evt) {
                self.score.val(
                    self.opt.half || self.opt.precision
                        ? that.data('score')
                        : $(this).data('score'),
                );
        ...
        _createStars: function () {
            ...
            for (var i = 1; i <= this.opt.number; i++) {
                var title = methods._getHint.call(this, i),
                    icon =
                        this.opt.score && this.opt.score >= i
                            ? 'starOn'
                            : 'starOff';
        ...
        _unlock: function () {
            ...
            for (var i = 0; i < this.opt.number; i++) {
                this.stars
                    .eq(i)
                    .attr('title', methods._getHint.call(this, i + 1));
            }
